...
void processBeshenceBank(BuildContext context, String address, bool newAccount) async {
  await BeshenceBank.ping(address: address);
  context.go("${newAccount?"/register":"/login"}/login_to_bank?&address=${Base64Encoder.urlSafe().convert(address.codeUnits)}");
}